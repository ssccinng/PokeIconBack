...
namespace PokeIconBack
{
    public partial class MainViewModel: ObservableObject
    {
        ...
        public MainViewModel()
        {
            ...
            var cc = TranslateHelper.PokeModels.OrderBy(s => aa1.IndexOf(s.Name_Chs)).DistinctBy(s => s.Name_Chs).ToArray();
            for (int i = 0; i < cc.Length; i++)
            {
                cc[i].MoveId = i + 1;
            }
            File.WriteAllText("test.json", JsonSerializer.Serialize(cc));
        }
